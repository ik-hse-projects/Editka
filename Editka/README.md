...
- [x] Восстановление состояния при перезапуске.
- [ ] ☆ Журналирование
...
- [x] ☆ Открытие и редактирование C#
    + [x] ★ Открытие всего решения или проекта, а не только одиночных файлов. 
...
- [x] ☆ Реализовать автоматическую подсветку синтаксиса кода на языке C#.
- [x] ☆ Реализовать возможность компиляции
...
- Список всех файлов всех других окон, которые были запущены
